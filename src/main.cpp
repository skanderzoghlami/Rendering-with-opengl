...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "Pyramid Render", NULL, NULL);
	...
	Shader lightShaderProgram("resources/shaders/lightShader.vert", "resources/shaders/lightShader.frag");
	...
	*/
	...
	std::string texPath = "/resources/images/";
